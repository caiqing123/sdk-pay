<?php
namespace TianQi\Util\TianQiHttp\Handler;

use Swoole\Coroutine;
use Swoole\Coroutine\Http\Client;
use TianQi\Util\TianQiHttp\Http\Response;
use TianQi\Util\TianQiHttp\FormDataBuilder;
...
class Swoole implements IHandler
{
	 ...
	 * 请求结果
	 *
	 * @var \TianQi\Util\TianQiHttp\Http\Response
	 */
    private $result;

	/**
	 * 请求内容
	 * @var \TianQi\Util\TianQiHttp\Http\Request
	 */
    private $request;
