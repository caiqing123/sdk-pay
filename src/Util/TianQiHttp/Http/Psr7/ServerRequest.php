<?php
namespace TianQi\PaySDK\Util\TianQiHttp\Http\Psr7;

use TianQi\PaySDK\Util\TianQiHttp\Http\Psr7\UploadedFile;
use Psr\Http\Message\ServerRequestInterface;
use TianQi\PaySDK\Util\TianQiHttp\Http\Psr7\Consts\MediaType;
use TianQi\PaySDK\Util\TianQiHttp\Http\Psr7\Consts\RequestHeader;
use TianQi\PaySDK\Util\TianQiHttp\Http\Psr7\Consts\RequestMethod;
...
class ServerRequest extends Request implements ServerRequestInterface
{
    ...
    /**
     * 上传的文件
     * @var \TianQi\Util\TianQiHttp\Http\Psr7\UploadedFile[]
     */
    protected $files = [];
     ...
     * 设置上传的文件
     * @param self $object
     * @param \TianQi\Util\TianQiHttp\Http\Psr7\UploadedFile[] $files
     * @return static
     */
