<?php
namespace TianQi\Util\TianQiHttp\Http\Psr7;

use TianQi\Util\TianQiHttp\Http\Psr7\UploadedFile;
use Psr\Http\Message\ServerRequestInterface;
use TianQi\Util\TianQiHttp\Http\Psr7\Consts\MediaType;
use TianQi\Util\TianQiHttp\Http\Psr7\Consts\RequestHeader;
use TianQi\Util\TianQiHttp\Http\Psr7\Consts\RequestMethod;
