...
use \TianQi\PaySDK\Lib\ObjectToArray;
...
class SDK extends Base
{
	/**
	 * 公共参数
	 * @var \TianQi\PaySDK\AlipayApp\Params\PublicParams
	 */
	public $publicParams;
	...
	public function sign($data)
	{
		...
		{
			case 'RSA':
				$result = \TianQi\PaySDK\Lib\Encrypt\RSA::$method($content, $key);
				break;
			case 'RSA2':
				$result = \TianQi\PaySDK\Lib\Encrypt\RSA2::$method($content, $key);
				break;
			default:
	...
	public function verifyCallback($data)
	{
		...
		{
			case 'RSA':
				return \TianQi\PaySDK\Lib\Encrypt\RSA::$method($content, $key, \base64_decode($data['sign']));
			case 'RSA2':
				return \TianQi\PaySDK\Lib\Encrypt\RSA2::$method($content, $key, \base64_decode($data['sign']));
			default:
